...
Workbench = RDK.Item('Workbench2')
Workbench_surname = RDK.Item('Workbench_surname2')
...
def name_surname_turned():
    robot.setPoseFrame(RDK.Item('Frame2'))                              #выбор смещенной и повернутой системы координат
    scale=1
